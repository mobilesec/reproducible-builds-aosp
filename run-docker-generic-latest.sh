...
compose_cmds() {
    cat <<EOF | tr '\n' '; '
        ...
        bash "./scripts/shared/analysis/22_generate-summary.sh" "${RB_AOSP_BASE}/diff/${BUILD_NUMBER}_${BUILD_TARGET}_${GOOGLE_BUILD_ENV}__${BUILD_NUMBER}_${BUILD_TARGET}_\$(lsb_release -si)\$(lsb_release -sr)"
