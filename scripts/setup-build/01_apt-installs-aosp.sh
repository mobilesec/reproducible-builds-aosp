...
main() {
    ...
    # Minimal docker installation of Ubuntu 18.04 misses the following tools that are needed for AOSP building
    # - JDK
    # - xxd
    sudo apt-get --assume-yes install openjdk-8-jdk xxd
