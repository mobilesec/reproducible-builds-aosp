    ...
    stages {
        ...
        stage('Analysis') {
            steps {
                ...
                sh "${SCRIPT_DIR}/scripts/shared/analysis/19_preprocess-imgs.sh \"${BUILD_NUMBER}\" \"${BUILD_TARGET}\" \"${BUILD_TARGET}\""
                ...
                sh "${SCRIPT_DIR}/scripts/shared/analysis/21_generate-metrics.sh \"${RB_AOSP_BASE}/diff/${BUILD_NUMBER}_${BUILD_TARGET}_${GOOGLE_BUILD_ENV}__${BUILD_NUMBER}_${BUILD_TARGET}_${RB_BUILD_ENV}\""
