    ...
    stages {
        ...
        stage('Analysis') {
            steps {
                ...
                sh "${SCRIPT_DIR}/scripts/shared/analysis/22_generate-summary.sh \"${RB_AOSP_BASE}/diff/${BUILD_NUMBER}_${BUILD_TARGET}_${GOOGLE_BUILD_ENV}__${BUILD_NUMBER}_${BUILD_TARGET}_${RB_BUILD_ENV}\""
