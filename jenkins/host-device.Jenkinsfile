    ...
    stages {
        ...
        stage('Analysis') {
            steps {
                ...
                sh "${SCRIPT_DIR}/scripts/shared/analysis/19_preprocess-imgs.sh \"${AOSP_REF}\" \"${GOOGLE_BUILD_TARGET}\" \"${RB_BUILD_TARGET}\""
                ...
                sh "${SCRIPT_DIR}/scripts/shared/analysis/21_generate-metrics.sh \"${RB_AOSP_BASE}/diff/${AOSP_REF}_${GOOGLE_BUILD_TARGET}_${GOOGLE_BUILD_ENV}__${AOSP_REF}_${RB_BUILD_TARGET}_${RB_BUILD_ENV}\""
